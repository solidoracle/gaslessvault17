...
import IbSquare_Ethers_EIP2771_PersonalSign from "./IbSquare_Ethers_EIP2771_PersonalSign";
import IbSquare_EIP2771_API from "./IbSquare_EIP2771_API";
...
function App() {
  ...
  return (
    <div className={classes.root}>
      ...
      >
        <Tab
          label="IbSquare + Ethers + EIP2771 + Personal Sign"
          {...a11yProps(0)}
        />
        <Tab label="IbSquare + EIP2771 + API" {...a11yProps(1)} />
      ...
      <TabPanel value={value} index={1}>
        <IbSquare_EIP2771_API />
      </TabPanel>

      <TabPanel value={value} index={0}>
        <IbSquare_Ethers_EIP2771_PersonalSign />
      </TabPanel>
